// Этот файл является основной логикой оверлея для Twitch.  Он совпадает с
// корневым viewer.js и не содержит инлайновых обработчиков, что
// соответствует требованиям CSP.  См. viewer.js в корне проекта для
